...
public class PoseConstants {
    ...
    public static final Rectangle test = new Rectangle("testZone", new Translation2d(0, 0), new Translation2d(1, 1));
    public static final Polygon testPolygon = new Polygon("testPolygon", new Translation2d(1, 1), new Translation2d(2, 2), new Translation2d(1, 0));
}
