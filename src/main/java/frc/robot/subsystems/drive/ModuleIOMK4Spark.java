...
public class ModuleIOMK4Spark implements ModuleIO {
  ...
  public ModuleIOMK4Spark(int module) {
    ...
    driveSpark =
        new MappedSparkMax(
            ...
            switch (module) {
              case 0 -> "frontLeftDriveCan";
              case 1 -> "frontRightDriveCan";
              case 2 -> "backLeftDriveCanId";
              case 3 -> "backRightDriveCan";
              default -> "nullDriveCan";
            });
    turnSpark =
        new MappedSparkMax(
            switch (module) {
            ...
            MotorType.kBrushless,
            switch (module) {
              case 0 -> "frontLeftTurnCan";
              case 1 -> "frontRightTurnCan";
              case 2 -> "backLeftTurnCanId";
              case 3 -> "backRightTurnCan";
              default -> "nullTurnCan";
            });
    driveEncoder = driveSpark.getEncoder();
    // turnEncoder = turnSpark.getAbsoluteEncoder();
    turnEncoder =
        new LoggedAnalogEncoder(
            switch (module) {
  ...
  public void updateInputs(ModuleIOInputs inputs) {
    ...
    ifOk(turnSpark, turnEncoder::get, (value) -> inputs.turnEncoder = new Rotation2d(value));
    // TODO our encoders don't have a built in get velocity. I can make a custom
    // class
