...
public class RobotContainer {
    ...
    private final LoggedNetworkNumber endgameAlert3 = new LoggedNetworkNumber("/SmartDashboard/Endgame Alert #3", 5.0);
    ...
    private void configureTurret() {
        ...
        RunTrajectoryCmd dynamicTrajectory = new RunDynamicTrajectory(
                m_turret,
                m_shooter,
                m_hood,
        ...
        RunTrajectoryCmd feedAlliance = new RunDynamicTrajectory(
                m_turret,
                m_shooter,
                m_hood,
