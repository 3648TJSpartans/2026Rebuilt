...
public class RobotContainer {
    ...
    switch (Constants.currentMode) {
      case REAL:
        ...
        m_intake =
            new Intake(
                new SingleSolenoid(
                    IntakeConstants.solenoidChannel,
        ...
        m_intake =
            new Intake(
                new SingleSolenoidSim(
                    IntakeConstants.solenoidChannel, "Subsystems/Intake/Down"),
                m_drive::getPose);
        m_turret =
            new Turret(
  ...
  private void configureSmartShoot() {
    ...
    Command driveSlow =
        DriveCommands.joystickDriveForTrajectory(
            m_drive,
            () -> -m_driveController.getLeftY(),
            () -> -m_driveController.getLeftX(),
  ...
  public void configureAutoChooser() {
    ...
    autoChooser.addOption(
        ...
        FFCharacterizationCmd.characterizeSystem(
            ...
            .finallyDo(m_shooter::stop));
    autoChooser.addOption(
        "Kicker simple FF Identification",
        FFCharacterizationCmd.characterizeSystem(
                m_kicker,
                speed -> m_kicker.runCharacterization(speed),
                () -> m_kicker.getFFCharacterizationVelocity())
            .finallyDo(m_kicker::stop));
  }
