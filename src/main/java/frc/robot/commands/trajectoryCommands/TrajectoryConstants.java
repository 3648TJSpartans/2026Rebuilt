...
public class TrajectoryConstants {
  ...
  public static final TunableNumber[] velocityMatrix =
      new TunableNumber[] {
        new TunableNumber("Trajectory/.0m/velocity", -.15),
        new TunableNumber("Trajectory/.5m/velocity", -.15),
        new TunableNumber("Trajectory/1.0m/velocity", -.15),
        new TunableNumber("Trajectory/1.5m/velocity", -.2),
        new TunableNumber("Trajectory/2.0m/velocity", -.25),
        new TunableNumber("Trajectory/2.5m/velocity", -.25),
        new TunableNumber("Trajectory/3.0m/velocity", -.25),
        new TunableNumber("Trajectory/3.5m/velocity", -.2),
        new TunableNumber("Trajectory/4.0m/velocity", -.2),
        new TunableNumber("Trajectory/4.5m/velocity", -.15),
        new TunableNumber("Trajectory/5.0m/velocity", -.05),
        new TunableNumber("Trajectory/5.5m/velocity", -.05),
        new TunableNumber("Trajectory/6.0m/velocity", -.05),
        new TunableNumber("Trajectory/6.5m/velocity", -.05),
        new TunableNumber("Trajectory/7.0m/velocity", -.05),
        new TunableNumber("Trajectory/7.5m/velocity", -.05),
        new TunableNumber("Trajectory/8.0m/velocity", -.05)
      };
}
