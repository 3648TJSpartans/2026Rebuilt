...
public class goToConstants {
    ...
    public static final TunableNumber tunableDriveP = new TunableNumber("Commands/DriveTo/drive/P", drivekP);
    public static final TunableNumber tunableDriveI = new TunableNumber("Commands/DriveTo/drive/I", drivekI);
    public static final TunableNumber tunableDriveD = new TunableNumber("Commands/DriveTo/drive/D", drivekD);
    public static final TunableNumber tunableThetaP = new TunableNumber("Commands/DriveTo/theta/P", thetakP);
    public static final TunableNumber tunableThetaI = new TunableNumber("Commands/DriveTo/theta/I", thetakI);
    public static final TunableNumber tunableThetaD = new TunableNumber("Commands/DriveTo/theta/D", thetakD);
    public static final TunableNumber tunableDriveMaxVelocity = new TunableNumber("Commands/DriveTo/drive/maxVelocity",
            driveMaxVelocity);
    ...
    public static final TunableNumber tunableDriveTolerance = new TunableNumber("Commands/DriveTo/drive/Tolerance",
            driveTolerance);
